...
def cheap_SAMO_COBRA_Init(problem, nCores=7, computeStartingPoints=16,
              ...
              oneShot=False,
              iterPlot=False,
              # VENDORED, ADDED: opt-in for PhaseII's end-of-run CSV/JSON dump
              # into ./batchresults/. Default False here where upstream had no
              # switch at all -- see the block it guards in
              # cheap_SAMO_COBRA_PhaseII for why.
              saveResults=False,
              initDesign="HALTON",
              initDesPoints=None,
              seqTol=1e-6,
    ...
    cobra['plot'] = iterPlot
    cobra['save_results'] = saveResults
